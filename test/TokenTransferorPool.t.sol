...
contract TestTokenTransferorPool is Test {
    ...
    function testDeploy() public {
        ...
        uint256 fee = bsc_c.getRouterFee(ethNetworkDetails.chainSelector,deployer, address(bsc_myToken), 100 ether);
        console.log("fee", fee);

        bsc_c.transferTokensPayNative{value: fee}(ethNetworkDetails.chainSelector,deployer, address(bsc_myToken), 100 ether);
