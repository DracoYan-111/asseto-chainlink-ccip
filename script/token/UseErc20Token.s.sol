...
contract UseErc20Token is Script {
    ...
    TokenPool constant tokenTransferorPool =
        TokenPool(0x4509a5E04b8B53cBE636b8bcEaAfDFb1D3936EEC);
    Erc20Token constant erc20Token =
        Erc20Token(0xCb36aBbc170B4A2cEe4e38Daf112096abcd52A0B);
    RegistryModuleOwnerCustom constant registryModuleOwnerCustom =
        RegistryModuleOwnerCustom(0x62e731218d0D47305aba2BE3751E7EE9E5520790);
    ITokenAdminRegistry constant tokenAdminRegistry =
        ITokenAdminRegistry(0x95F29FEE11c5C55d26cCcf1DB6772DE953B37B82);

    address constant otherTokenTransferorPool =
        address(0x88885cC572f2c0DD980e98D5D36cDF372EcaADD1);
    address constant otherErc20Token =
